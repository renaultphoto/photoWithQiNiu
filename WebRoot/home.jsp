<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %><!DOCTYPE html><html lang="zh-cn">
    <%
    	String qiNiuUrl ="";//填写你在七牛云的测试域名
    %>
  <head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-xs-2 col-xs-offset-2">
                          <a href="#" class="thumbnail text-center">
                            <img name="${image.name}" date="<fmt:formatDate value='${image.date}' pattern='yyyy-MM-dd HH:mm'/>" style="width: 140px; height: 130px;" src="<%=qiNiuUrl %>/${image.url}"><!--这里请填写自己的链接地址，详见下图-->
